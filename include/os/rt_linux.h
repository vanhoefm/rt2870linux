...
#define USB_GET_DEV			usb_get_dev
#define USB_REG_DRV			usb_register_driver
#define USB_REGISTER		usb_register
#define USB_DEREGISTER		usb_deregister
#else

#define USB_CONTROL_MSG		rausb_control_msg
#define USB_GET_DEV			rausb_get_dev
#define USB_REG_DRV			rausb_register_driver
#define USB_REGISTER		rausb_register
#define USB_DEREGISTER		rausb_deregister
